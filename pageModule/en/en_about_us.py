...
class About:
    ...
    # 第一行图片
    honor1 = (By.XPATH, '/html/body/section[5]/div/div[2]/div[1]/div[1]/div')
    # 第二行图片
    honor2 = (By.XPATH, '/html/body/section[5]/div/div[2]/div[1]/div[2]/div')

    def scroll_title4(self):
        tool.scroll_to_element(self.driver, tool.wait_ele_be_founded(self.driver, 10, *self.title4))

    def get_honor_images(self):
        line1 = tool.wait_ele_be_founded(self.driver, 5, *self.honor1)
        line2 = tool.wait_ele_be_founded(self.driver, 5, *self.honor2)
        images1 = line1.find_elements(By.TAG_NAME, 'img')
        images2 = line2.find_elements(By.TAG_NAME, 'img')
