...
class Product:
    ...
    def get_line_1_img1(self):
        return tool.wait_ele_be_founded(self.driver, 10, *self.line_1_img1)

    def get_line_1_img2(self):
        return tool.wait_ele_be_founded(self.driver, 10, *self.line_1_img2)

    def get_line_1_txt(self):
        return tool.wait_ele_be_founded(self.driver, 10, *self.line_1_txt)

    def get_line_2_img1(self):
        return tool.wait_ele_be_founded(self.driver, 10, *self.line_2_img1)

    def get_line_2_img2(self):
        return tool.wait_ele_be_founded(self.driver, 10, *self.line_2_img2)

    def get_line_2_txt(self):
        return tool.wait_ele_be_founded(self.driver, 10, *self.line_2_txt)

    def get_line_3_txt(self):
        return tool.wait_ele_be_founded(self.driver, 10, *self.line_3_txt)

    def get_line_3_img(self):
        return tool.wait_ele_be_founded(self.driver, 10, *self.line_3_img)
    ...
    def get_ep_images(self):
        """设备图片列表"""
        return [tool.wait_ele_be_founded(self.driver, 10, *(By.XPATH, i)) for i in self.ep_images]
    ...
    def get_all_svg(self):
        """所有定制化服务图标"""
        return [tool.wait_ele_be_founded(self.driver, 10, *i)
