...
class News:
    ...
    """---------------------tab栏---------------------"""
    # 企业资讯
    enterprise_btn = (By.XPATH, '/html/body/section[2]/div[1]/ul/li/a')

    def get_enterprise_btn(self):
        return tool.find_element(self.driver, *self.enterprise_btn)
    ...
    def get_all_news_cards(self):
        return tool.find_elements(self.driver, *self.news_cards)
    ...
    def get_per_btn(self):
        return tool.find_elements(self.driver, *self.page_btn)[0]

    def get_next_btn(self):
        return tool.find_elements(self.driver, *self.page_btn)[-1]

    def turn_to_page(self, page):
        tool.find_element(self.driver, *self.page_input).set_value(page)
    ...
    def get_news_title(self):
        return tool.find_element(self.driver, *self.news_title)
    ...
    def get_recommend_cards(self):
        """所有推荐新闻的列表"""
        return tool.find_elements(self.driver, *self.recommend_cards)
