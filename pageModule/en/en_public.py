...
class Public:
    ...
    def get_phone(self):
        return tool.wait_ele_be_founded(self.driver, 10, *self.phone)

    def get_company_email(self):
        return tool.wait_ele_be_founded(self.driver, 10, *self.company_email)

    def get_hr_email(self):
        return tool.wait_ele_be_founded(self.driver, 10, *self.HR_email)

    def get_xm_addr(self):
        return tool.wait_ele_be_founded(self.driver, 10, *self.xm_addr)

    def get_sh_addr(self):
        return tool.wait_ele_be_founded(self.driver, 10, *self.sh_addr)

    def get_sc_img(self):
        return tool.wait_ele_be_founded(self.driver, 10, *self.sc_img)

    def get_side_btn(self):
        return tool.wait_ele_be_founded(self.driver, 10, *self.side_btn)

    def get_serve_img(self):
        return tool.wait_ele_be_founded(self.driver, 10, *self.serve_img)

    def get_serve_phone(self):
        return tool.wait_ele_be_founded(self.driver, 10, *self.serve_phone)

    def get_to_top_btn(self):
        return tool.wait_ele_be_founded(self.driver, 10, *self.to_top_btn)